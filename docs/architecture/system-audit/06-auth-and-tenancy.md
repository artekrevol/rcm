...
- ✅ **`WITH CHECK` clauses on the 6 Phase 3 policies — added in Sprint 1a.** All 12 policies now enforce tenant isolation on INSERT/UPDATE as well as SELECT/DELETE. Cross-tenant INSERTs are DB-blocked.
...
- ✅ **`WITH CHECK` clauses on the 6 Phase 3 policies** — added in Sprint 1a; cross-tenant INSERTs are now DB-blocked.
